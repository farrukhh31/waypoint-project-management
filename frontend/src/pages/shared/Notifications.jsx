                      ...
                      >
                        ...
                        {!n.isRead && (
                          <button
                            ...
                            className="shrink-0 self-center text-xs font-medium text-route-600 opacity-100 transition-opacity hover:underline sm:opacity-0 sm:group-hover:opacity-100 sm:group-focus-within:opacity-100"
                          >
                            Mark as read
                          </button>
                        )}
